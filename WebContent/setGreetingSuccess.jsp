	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="mailPane">
				...
				<div id="mailPaneMain">
<%
					String uname=(String)session.getAttribute("from");
					String fest=(String)session.getAttribute("festive");
					Date d=new Date();
					if(fest.equals("MakarSankranti"))
					{	
						d.setDate(14);
						d.setMonth(0);
					}
					...
					if(fest.equals("Dussehra"))
					{	
						d.setDate(06);
						d.setMonth(9);
					}
					if(fest.equals("Diwali"))
					{	
						d.setDate(26);
						d.setMonth(9);
					}
					...
					if(fest.equals("Christmas"))
					{	
						d.setDate(25);
						d.setMonth(11);
					}
					String friends=request.getParameter("txtTo");
					if(friends!=null)
					{
							seasons s=new seasons();
							s.setDateoffest(d);
							s.setFestivalname(fest);
							s.setUsername(uname);
							s.setFname(friends);
							wbservice wb=new wbservice();
							int j=wb.addseasons(s);
					}
%>
					<table width="550px">		
						<tr>
							<td>
								<img alt="Wishbook" src="images/check.png" width="35px" height="35px" style="float: left; margin-left: 55px">
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">The user has been added to your automated wish list</div>
							</td>
						</tr>						
					</table>
				</div>
