...
<%@page import="com.services.SendMailUsage"%><html>
<head>
...
//						String username = "g_vinodkumar";
						...
						if(to.length()>23)
						{
							to=to.substring(to.length()-23,to.length()-1);
						}
						String subject = request.getParameter("txtSubject");
						String message = request.getParameter("txtMsg");
						service.wishalert(user,to,subject,message);
%>
				<b style="font-size: 12px;">Hi <%= service.returnName(service.returnEmail(username)) %>!</b><br/>
				Message successfully sent.You may now navigate away from this page...<br/>
				...
				<div id="mailPaneMain">
					...
					<table id="inboxMailList">	
						<tr><td>
							...
							<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">Your message has been successfully sent</div>
						</td></tr>
					</table>					
