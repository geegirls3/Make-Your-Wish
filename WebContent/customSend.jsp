...
<%
String s1=request.getParameter("txtPath");
//out.println(s);
String to=request.getParameter("txtTo");
String from=user;//take it sessionAtt
//wbservice service = new wbservice();
service.sendCustomGreeting(from,to,"Custom Greeting",s1);
%>
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">Your greeting has been successfully sent</div>
							</td></tr>						
							</table>
				</div>
