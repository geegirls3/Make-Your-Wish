...
<title>Add Friend : Request Sent</title>
...
//						String username = "g_vinodkumar";
				...
				Your friend request has been successfully sent to the selected user.You may now navigate away from this page...<br/>
			...
			<div id="addFriendPane">
				...
				<div id="addFriendPaneMain" style="float: none;">					
<%
					...
					if(friend!=null)
					{
						...
						ws.friendrequest(from,friend);	
%>
						<table width="550px" align="center" style="text-align: center;">
						<tr height="30px" width="550px" style="text-align: center;"><td width="550px" style="text-align: center;">									
						<img alt="Wishbook" src="images/Message.png" width="50px" height="50px" style="float: left; margin-left: 50px">
						<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 20px;">Your friend request has been sent to <%= service.returnName(friend) %></div>						
						</td></tr>
						</table>
<%						
					}
