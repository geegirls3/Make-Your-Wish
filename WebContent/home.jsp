...
#notification {
	background: url('images/home/bg_postlist.png');
	background-repeat: no-repeat;
	height: 175px; 
	width:614px;
}
...
#faqBack {
	background-image: url('images/home/featured_highlight.png');
	background-repeat: no-repeat;	
}
...
<f:view>
	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			<div id="top">
				<img alt="Make Your Wish" src="images/home/logo_sitehead.png" height="52px" width="179px" align="left" style="display: inline; float: left;">
				<ul id="topLinks">
			...
			<div id="picScroll" class="color">
				<div id="makeMeScrollable">
					<div id="leftScroll" class="scrollingHotSpotLeft">
						<img alt="Go Left" src="images/arrow_left.png" style="margin-left:5px;margin-top:50px;">
					</div>
					<div id="rightScroll" class="scrollingHotSpotRight">
						<img alt="Go Right" src="images/arrow_right.png" style="margin-left:10px;margin-top:50px;">
					</div>
					<div class="scrollWrapper">
						<div class="scrollableArea">
							<img src="images/sliderPics/1.png" alt="Demo image" />
							<img src="images/sliderPics/2.png" alt="Demo image" />
							<img src="images/sliderPics/3.png" alt="Demo image" />
							<img src="images/sliderPics/4.png" alt="Demo image" />
							<img src="images/sliderPics/5.png" alt="Demo image" />
						</div>
					</div>
				</div>				
			</div>
			<div id="faqPane">
				<table width="550px" style="padding-top: 15px">
					<tr height="175px">
						<td id="faqBack" width="239px">
							<table width="220px" style="color: #ebe9e8; padding-left: 25px; padding-top: 10px">
								<tr height="80px" style="text-align: center; font-size: 18px; font: Garamond; color: white;">
									<td >
										<p>WHY</p>
										<p style="padding-top: 5px">'Make Your Wish'</p>
									</td>
								</tr>
								<tr height="65px">
									<td style="text-align: center;">
										<p style="text-align: center; font-size: 12px">
											Make Your Wish is a web app to automate the process of wishing ones' colleagues on...											
										</p>										
									</td>
								</tr>
								<tr>
									<td style="padding-left: 50px">
										<a href="intro.jsp"><img src="images/home/readmore_featured.png" height="26px" width="82px"></a>
									</td>
								</tr>
							</table>
						</td>
						<td id="faqPic">
							<img src="images/faq_pic.png" width="275px" height="150px" style="padding-left: 20px">
						</td>
					</tr>					
				</table>
			</div>
			<div id="notification" style="margin-top: 15px;">
				<div id="notification_inner" style="margin-left: 70px;">
					<table style="max-height: 150px; overflow: hidden;">
						<tr>
							<td>
...
//					String username = "deepakkrishnan";
					...
					String subjectSubstringToSearch = "wishbook Alert";
	...
	try
	{
        ...
        for (int i = found.length-1,j = 0; i >=0 && j<5; i--,j++)
    	{
        	Message m = found[i];
        	String mimeType = m.getContentType();
           	Object o = m.getContent();
%>
				<div class="notification" style="text-align: left; float: none; margin-top: 10px">
					<img src="images/home/bullet.png" width="9px" height="12px" style="float: left; margin-top: 4px;"/>
					<a href="wishbook_external.jsp" style="float: left; margin-left: 5px; text-decoration: none; color: #605f61; font-size: 12px"><%= (String)o %></a>
					<br/>
				</div>						
<%
	    } //End of for
...
%>
			...
			<td width="260px" style="margin-left: 10px; padding-left:10px ;margin-right: 10px; padding-right: 10px; vertical-align: bottom">
				<b style="color: #605f61; font-size: 15px; text-align: left; margin-top: 10px; float: left;">
<% 
    				out.println("There are "+ count  + " messages in your inbox");
%>
				<a href="inbox.jsp" style="margin-top: 15px;"><img src="images/home/view_notifications.png"/></a>
  				</b> 
    		</td>
		</tr>
		</table>
