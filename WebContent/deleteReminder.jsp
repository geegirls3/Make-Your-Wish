...
//						String username = "deepakkrishnan";
				...
				The reminder has been deleted.You may now navigate to any other page...<br/>
...
<%
								...
								try{
									...
									service.deletereminder_usingindex(index);
								}
...
%>
								...
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">The reminder you selected was deleted successfully</div>
							</td></tr>						
							</table>
				</div>
