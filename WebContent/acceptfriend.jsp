	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				You have accepted the friend request.Now you may navigate away from this page...
...
String from=request.getParameter("from");
						int checkindex=service.checkfriends(to,from);
						if(checkindex==1)
						{
...
%>							
							...
							<tr><td colspan="4">
								...
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">You are already a friend with this user</div>		
							</td></tr>	
<%						}
						else
						{
%>
							<tr><td colspan="4">
								<img alt="Wishbook" src="images/check.png" width="35px" height="35px" style="float: left; margin-left: 175px">
<%
							if(to!=null)
							{
							wishlistpk wpk=new wishlistpk();
							wpk.setUname(from);
							wpk.setFname(to);
							service.invitation(wpk);
							service.wishalert(to,from,"Friend Request","Your friend request is accepted by "+service.returnName(to));
          					}

%>
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">You accepted friend request </div>
							</td></tr>		<%} %>				
							</table>
				</div>
			...
			<div id="sideMenu">
				...
				<table id="currUserDetails" style="margin-top: 15px; margin-left: 12px; float: left;">
					<tr>
						<td width="100px">
							<center>
							<img src="images/profilePics/deepak_krishnan.png" width="80px" height="80px"/>
							</center>
						</td>
					...
					<tr style="height: 30px">
						...
						<td style="text-align: left;">
							<div id="currUserLinks">
								<ul id="userLinks">
									<li id="userLinkedin"><a href="http://www.linkedin.com"></a></li>
									<li id="userTwitter"><a href="http://www.twitter.com"></a></li>
									<li id="userFacebook"><a href="http://www.twitter.com"></a></li>
									<li id="userEmail"><a href="mailto:deepakkrishnan@hotmail.com"></a></li>
								</ul>
							</div>
						</td>
					</tr>
				...
				<div id="sideMenuLinks" style="margin-top: 0px; padding-top: 0px">
					<ul id="menuLinks">
						...
						<li id="faqLink"><a href="mailto:deepakkrishnan@hotmail.com"></a></li>
					</ul>
				</div>
				</td>
				</tr>
