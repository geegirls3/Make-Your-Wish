...
<%
								...
								if(a!=null)
								{
									fromno=message.length-((10*(a-1))+1);	 						
								}
...
%>
									<tr style="color: gray;">
										<td>
											<a href="open_mail.jsp?fromCurr=<%= from[0] %>&subjectCurr=<%= subj %>&dateCurr=<%= date.toString() %>" class="openMail"><img src="images/Message Open.png" width="35px" height="35px"/></a>
										</td>
										<td style="text-align: left;">
											<%= subj %>
										</td>
										<td style="text-align: left;">
											<%= service.returnName(from[0].toString()) %>
										</td>
										<td>
<%
