...
//						String username = "g_vinodkumar";
				...
				Please click on the buttons tagged with each of the wish to view the profile of the sender or to reply... <br/>
			...
			<div id="addFriendPane">
				...
				<div id="addFriendPaneMain">
					<form id="postMessage" action="wishbook_external.jsp" style="width: 565px; vertical-align: middle">
						<b style="color: gray;">Enter your message</b><br/>
						<input type="text" id="msgText" name="msgText"/>
						<br/>
						<input id="postMsg" type="submit" value="Post" style=""/>
<%
...
%>						
						<table width="550px" style="color: gray; margin-left: 10px;">
							<tr height="75px">
								<td style="font-size: 25px; float: none;color: #0b92d6;">
									<img alt="Wishbook" src="images/Present.png" width="50px" height="50px" style="float: left;">
									<div style="float: left; margin-top: 10px;">My Wishbook</div>
								</td>
							</tr>
<%
						Integer a=Integer.parseInt(request.getParameter("fromno"));
						int fromno=0;
						if(a!=null)
						{
							fromno=list2.size()-((5*(a-1))+1);	 						
						}
...
%>
								...
								<tr style="background-color: #e7e6eb;">
									<td width="550px" style="border-style: solid;border-color: #cbcacf; border-width: 2px; float: none; font-size: 11px">
										<img src="images/home/bullet.png" width="9px" height="12px" style="float: left; padding-top: 2px;margin-top: 5px; margin-left: 5px"/>									
										<b style="float: left; margin-left: 5px; margin-top: 5px;">Posted by <%= service.returnName(ent1.getFromuser()) %></b>
										<a href="deletewish.jsp?slno=<%=ent1.getSlno() %>" style="float: right;"><img src="images/delete.png" width="25px" height="25px" alt="Reply" title="Delete wish"></a>								
										<a href="wishbook_external.jsp" style="float: right;"><img src="images/Balloon.png" width="25px" height="25px" alt="Reply" title="Reply"></a>
										<a href="viewProfile.jsp?user=<%= service.returnUsername(ent1.getFromuser()) %>" style="float: right;"><img src="images/Member Card.png" width="25px" height="25px" alt="View Profile" title="View Profile"></a>
										<a href="viewReplyThread.jsp?slno=<%=ent1.getSlno() %>&to=<%= ent1.getFromuser() %>" style="float: right;">
											<img src="images/reply.png" width="25px" height="25px" alt="Reply" title="Comment on this thread">
										</a>
...
%>
						<tr><td>
						<b style="float: left; padding-top: 5px;">Read rest of the wishes: </b>
<%
						...
						{
%>
							<a style="text-decoration: none; float: left;" href="wishbook_external_next.jsp?fromno=<%= k %>"><img src="images/plus.png" width="25px" height="25px" title="Go to page <%= k %>"></a>
<%
		}
%>
						</td></tr>
...
<%
						...
						<tr><td colspan="4">
							<img alt="Wishbook" src="images/error.png" width="35px" height="35px" style="float: left; margin-left: 120px">
							<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">There are no wishes to list in your wishbook</div>
						</td></tr>						
						</table>
<%
}
