...
.question {color:gray; text-align: justify;}

.answer {color:gray; text-align: justify;}
				...
				<div id="mailPaneMain">
							...
							<tr height="75px">
								<td style="font-size: 25px; float: none;color: #0b92d6;">
									<img alt="FAQs" src="images/faq.png" width="50px" height="50px" style="float: left;">
									<div style="float: left; margin-top: 10px;">FAQs</div>
								</td>
							</tr>						
							</table>							
            
            <table width="550px">
                  <tr class="question"><td><b>1. What is the procedure to add friends?</b></td></tr>
                  <tr class="answer"><td>Ans.There is a option to add friends on the user home page.The user has to log in before he can use this option.
                            On clicking the add friends the user will be navigated to another page where a list of people whom he can add as friends will be displayed 
                  </td> </tr> 
                  <tr height="10px">
                  </tr>
                  <tr class="question"><td><b>2. How do u send a custom greeting?</b></td></tr>
                  <tr class="answer"><td>Ans.There is a option to send a custom greeting on the user home page.The user has to log in before he can use this option.
                            On clicking the custom greeting the user will be navigated to another page where a paint application will be provided to the user.The user can paint the greeting as per his wish
                            and send it to his friend.
                  </td></tr>
                  <tr height="10px">
                  </tr>
                  
                  <tr class="question"><td><b>3.How to send a wish to multiple users? </b></td></tr>
                  <tr class="answer"><td>Ans.A wish can be sent to multiple users via the wishlist.
                  The wishlist is a option present on the Home Page.It contains the list of people who are to recieve the greetings.           
                  </td></tr>
                  <tr height="10px">
                  </tr>
                  <tr class="question"><td><b>4.How to edit your profile?</b></td></tr>
                  <tr class="answer"><td>Ans.On the home page there is a option to edit the profile.By clicking on that option the user
                  will be moved to another page where all his details will be kept.He can update and save the details
                  </td></tr>
                  </table>
