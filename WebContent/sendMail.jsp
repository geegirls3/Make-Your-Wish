...
<script type="text/javascript" src="js/validation_sendmail.js"></script>
				...
				<div id="mailPaneMain">
					<form id="frmSendMail" action="mailer.jsp" name="at" style="text-align: left; margin-left: 25px; ">
						<table border="0" style="text-align: left; width: 550px;">
							...
							<td>
								<input type="text" id="txtTo" name="txtTo" style="height: 20px; width: 490px; margin-top: 10px; margin-bottom: 10px; border-style: solid;border-color: #cbcacf; border-width: 2px;"/>
							</td>
							</tr>
							<tr>
							<td>
							...
							<td>
								<input type="text" id="txtSubject" name="txtSubject" style="height: 20px; width: 490px; margin-top: 10px; margin-bottom: 10px; border-style: solid;border-color: #cbcacf; border-width: 2px;"/>
							</td>
							</tr>
						</table>
