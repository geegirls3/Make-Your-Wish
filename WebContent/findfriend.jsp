	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				Please click on the friends name to view their profile and add them as your friend...<br/>
					...
					<table id="newFriendEntryList">
						<tr height="75px">
								<td colspan="2" style="font-size: 25px; float: none;color: #0b92d6;">
									...
									<div style="float: left; margin-top: 10px;">Add Friends</div>
								</td>
							</tr>
							<tr style="height: 10px"></tr>
<%
					String from=(String)session.getAttribute("email_curr");
//					String from="Makeawish3@myssmtp.com";
					...
					if(from!=null)
					{
						...
						List rs=ws.findfriends(from);
						int size1=rs.size();
		
					    for(int i=0;i<size1;i++){
					        String friendEmail = (String)rs.get(i);
        					String friendName=service.returnName(friendEmail);        
%>
							<tr style="float: none">
								<td style="text-align: right;" width="25px"><img id="addFriendBullet" src="images/User.png" height="25px" width="25px"/></td>
					        	<td style="text-align: left;"><a id="addFriendName" href="addfriend.jsp?friend=<%= friendEmail %>&from=<%= from %>"><%= friendName %></a></td>
					        </tr>
<%						
						}
					}
					%></table><%
						...
						%>						
													...
													<tr><td colspan="4">
														...
														<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">You are friend with all the users</div>
													</td></tr>						
													</table>
						<%
											}
			...
			<div id="sideMenu">
				...
				<div id="sideMenuLinks" style="margin-top: 0px; padding-top: 0px">
					<ul id="menuLinks">
						...
						<li id="seasonsLink"><a href="vinodfunc.jsp"></a></li>
						<li id="customLink"><a href="seasons.jsp"></a></li>
