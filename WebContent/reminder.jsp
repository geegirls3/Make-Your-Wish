...
<script type="text/javascript" src="js/validation_reminder.js"></script>
		...
		<table width="550px" style="color: gray;">
			<tr height="75px">
				<td colspan="4" style="font-size: 25px; float: none;color: #0b92d6;">
					<img alt="Reminder" src="images/alarm.png" width="50px" height="50px" style="float: left;">
					<div style="float: left; margin-top: 10px;">Reminder</div>
				</td>
			</tr>			
			<tr style="float: none;">
			...
			<tr style="float: none;">
				<td colspan="4" style="text-align: left;">	
					<input type="submit" value="Save" class="buttonStyle" onclick="return rem()">
					<input type="reset" value="Reset" style="margin-left: 15px;" class="buttonStyle">				
				</td>
			</tr>
			<tr style="height: 10px"></tr>
		</table>
		<input type="hidden" id="txtTo" name="txtTo" class="inputFieldStyle" value="<%= service.returnEmail(username) %>">
