...
//						String username = "deepakkrishnan";
				...
				The mail has been deleted.You may now navigate to any other page...<br/>
...
%>
								...
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">The mail you selected was deleted successfully</div>
							</td></tr>						
							</table>
				</div>
