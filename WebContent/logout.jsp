			...
			<div id="addFriendPane">
				...
				<div id="addFriendPaneMain">
					<table id="inboxMailList">		
						<tr><td>
							<img alt="Logout" src="images/error.png" width="35px" height="35px" style="float: left; margin-left: 135px">
							<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">You have successfully logged out</div>
						</td></tr>	
						<tr>
    						<td>
    							<img alt="Login" src="images/Power.png" width="35px" height="35px" style="float: left; margin-left:225px">
								<div style="font-size: 15px; float: left; margin-top: 8px"><a style="text-decoration: none; color: #0b92d6;" href="login.jsp">Login</div>
    						</td>    							
    				 	</tr>					
					</table>
				</div>
