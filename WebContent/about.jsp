...
<f:view>
	...
	<ul id="menuList">
		...
		<li id="rightOfMenu"><a href="css_syntax.asp"></a></li>
	</ul>
	</div>
	<div id="menuBottom">
	<%
...
//		String username = "g_vinodkumar";
	...
	<div id="mailPane">
	<div id="mailPaneTop"></div>
	<div id="mailPaneMain">
		<form action="autoset.jsp">
		<table width="550px" style="color: gray;">
			<tr height="75px">
				<td colspan="4" style="font-size: 25px; float: none;color: #0b92d6;">
					<img alt="Scheduler" src="images/Shield.png" width="50px" height="50px" style="float: left;">
					<div style="float: left; margin-top: 10px;">About US</div>
				</td>
			</tr>			
							
    						<tr>
    							<td ><img id="newUserBullet" src="images/profilePics/shalini.png" height="100px" /></td>
    							<td width="520px" align="left" style="padding-left: 10px"><label style="font-size: 15px; float: none;color: #0b92d6;">Project Mentor</label><br><label>Shalini Rai<br> Email:Shalini_Rai01@infosys.com<br>Phone no:7760684240 <br> </label> </td>    							
    						</tr>
    						<tr height="10"></tr>
							<tr>
    							<td ><img id="newUserBullet" src="images/profilePics/chandra1.PNG" height="100px" /></td>
    							<td width="520px" align="left" style="padding-left: 10px"><label>Chandra Mouli<br> Email:404045@infosys.com<br>Personal Email:chandramouli111@gmail.com <br>Phone no:9379504022 <br> </label> </td>    							
    						</tr>
    						<tr height="10">
    						</tr>
    						<tr>
    							<td  ><img id="newUserBullet" src="images/profilePics/deepak1.png" width="85px" /></td>
    							<td width="520px" align="left" style="padding-left: 10px"><label>Deepak Krishnan<br> Email:404048@infosys.com<br>Personal Email:deepakkrishnan@hotmail.com<br>Phone no:8197727033 <br> </label> </td>    							
    						</tr>
    						<tr height="10">
    						</tr>
    						<tr>
    							<td  ><img id="newUserBullet" src="images/profilePics/dinesh1.png" height="100px" /></td>
    							<td width="520px" align="left" style="padding-left: 10px"><label>Dinesh Kumar<br> Email:404052@infosys.com<br>Personal Email:dineshyamato@gmail.com<br>Phone no:9901945053 <br> </label> </td>    							
    						</tr>
    						<tr height="10">
    						</tr>
    						<tr>
    							<td ><img id="newUserBullet" src="images/profilePics/vinod1.png" height="100px" /></td>
    							<td width="520px" align="left" style="padding-left: 10px"><label>Vinod Kumar<br> Email:404065@infosys.com<br>Personal Email:vinodgoney@gmail.com<br>Phone no:9902978186 <br> </label> </td>    							
    						</tr>
    						<tr height="10">
    						</tr>
	...
	<div id="mailPaneBottom"></div>
	</div>
	</div>
	<div id="right">
	<div id="search">
	<div id="searchText"><input id="searchInput" name="keyword" border="0px"
		maxlength="31" /></div>
	<div id="searchButton"><a href="retrievesearch.jsp"><img
		src="images/home/search.png" height="33px" width="25px"></a></div>
	</div>
	<div id="sideMenu">
	...
	<table id="currUserDetails"
		...
		<tr>
			<td width="100px">
			<center><img src="<%= currUserInfo.get(0).getPropic() %>" width="80px" height="80px"/></center>
			</td>
			<td width="200px"
			...
			<%
					for (int i = 0; i < size1; i++) {
						...
						out.println("<b style=\"font-size:15px;\">"
								+ s.getFirstName() + " " + s.getLastName()
								+ "</b><br/>");
						out.println(s.getDob() + "<br/>");
