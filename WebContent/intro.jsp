...
<title>Why 'Make Your Wish'</title>
		...
		<div id="left">
			...
			<div id="mailPane">
				...
				<div id="mailPaneMain">
							...
							<tr>
    							<td style="font-size: 25px; color: #0b92d6; float: none;">
    								<img alt="Make Your Wish" src="images/Anchor.png" width="50px" height="50px" style="float: left;"/>
    								<div style="float: left; margin-top: 10px;">Why 'Make Your Wish'</div>
    							</td>    							
    						</tr>		
							<tr><td>
								<div style="color: gray; float: left; margin-top: 8px;">
									<p style="text-align: justify;">
									Make Your Wish is an application to automate the process of wishing ones' colleagues on occasions such
									as birthdays and anniversaries.The major functionality includes the provision of a variety of templates
									to wish his/her friends.One can also create customized greeting cards using paint.In addition,this 
									application allows a user to maintain his friends list(Wish List) and a personal page(Wish Book) where one 
									chats with his friends as per his convenience.More so over Seasons greetings are available keeping in mind
									the numerous festivals celebrated in our country.
									</p>
								</div>
							</td></tr>						
							</table>
