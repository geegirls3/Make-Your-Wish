...
<title>Schedule Greetings</title>
...
<script type="text/javascript" src="js/validate_automated.js"></script>
...
//		String username = "g_vinodkumar";
	...
	<div id="mailPaneMain">
		<form action="autoset.jsp" name="at">
		
		<table width="550px" style="color: gray;">
			<tr height="75px">
				<td colspan="4" style="font-size: 25px; float: none;color: #0b92d6;">
					<img alt="Scheduler" src="images/Clock.png" width="50px" height="50px" style="float: left;">
					<div style="float: left; margin-top: 10px;">Scheduler</div>
				</td>
			</tr>	
			<%try{
			List friends = service.listExistingfriends(user);
			
			%>		
			<tr style="float: none;">
				<td width="75px" style="text-align: left;" class="topicStyle">Date</td>
				<td colspan="3" style="text-align: left;"><input type="text" name="dated" class="inputFieldStyle"></td>
			</tr>			
			<tr style="height: 10px"></tr>
			<tr style="float: none;">
				<td style="text-align: left;" class="topicStyle">Hours</td>
				<td style="text-align: left; width: 84px">
					<select name="hrs" class="inputFieldStyle">
				...
				<td style="text-align: left; width: 68px" width="30px" class="topicStyle">Minutes</td>
				<td style="text-align: left; width: 426px">
					<select name="mins" class="inputFieldStyle">
						<option value="0">0</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
			...
			<tr style="float: none;">
				<td style="text-align: left;">					
					<label style="color: gray;" class="topicStyle">To:</label>
				</td>
				<%   %>
				<td colspan="3" style="text-align: left;">
					<select id="txtTo" name="txtTo" class="inputFieldStyle" style="width: 478px;">
<%					
					
					for(int i=0;i<friends.size();i++)
					{
						String email_friend = (String)friends.get(i);
						String uname_friend = service.returnUsername(email_friend);
						String name_friend = service.returnName(email_friend);							
%>						
						<option value="<%= email_friend %>" style="height: 20px; "><%= name_friend %></option>
<%
					}
%>									
					</select>
			...
			<tr style="height: 10px"></tr>
			<tr style="float: none;">
				<td style="text-align: left;" class="topicStyle">Subject</td>
				<td colspan="3" style="text-align: left;">
					<input type="text" name="subject" class="inputFieldStyle" style="width: 475px;">
				</td>
			</tr>
			<tr style="height: 10px"></tr>
			<tr style="float: none;">
				<td style="text-align: left;" class="topicStyle">Message</td>
				<td colspan="3" style="text-align: left;">
					<input type="text" name="message" class="inputFieldStyle" style="width: 475px; height: 75px;">
				</td>
			</tr>
			<tr style="height: 10px"></tr>
			<tr style="float: none;">
				<td colspan="4" style="text-align: left;">	
					<input type="submit" value="Save" onclick="return auto()" class="buttonStyle">
					<input type="reset" value="Reset" style="margin-left: 15px;" class="buttonStyle">				
				</td>
			</tr>
			<tr style="height: 10px"></tr>			
		</table>
		...
		<%}
					...
					<tr><td colspan="4">
						<img alt="Wishbook" src="images/error.png" width="35px" height="35px" style="float: left; margin-left: 150px">
						<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">You currently have no friends</div>
					</td></tr>						
					</table>
<%
			}
