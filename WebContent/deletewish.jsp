		...
		<div id="left">
			...
			<div id="mailPane">
				...
				<div id="mailPaneMain">
							...
							<tr><td colspan="4">
								<img alt="Wishbook" src="images/check.png" width="35px" height="35px" style="float: left; margin-left: 150px">
<%
wbservice wb=new wbservice();
Integer i=Integer.parseInt(request.getParameter("slno"));
wb.deletewish(i);
//out.println("Deleted");


%>
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">Your wish have been deleted</div>
							</td></tr>						
							</table>
				</div>
						...
						<td width="200px" style="overflow: auto; text-align: left; color: #a1a0a8; padding-left: 5px; font-family: sans-serif; font-size: 12px;">
							<%								
								for(int p=0;p<size1;p++){
	    							user_info s=(user_info)currUserInfo.get(p);
