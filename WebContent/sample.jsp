...
user_info_temp ut = (user_info_temp) session
...
u.setPe(ut.getPe());
u.setTw(ut.getTw());
u.setPropic(ut.getPropic());

u.setFirstName(ut.getFirstName());
u.setLastName(ut.getLastName());
u.setUname(ut.getUname());
u.setPassword(ut.getPassword());
u.setStreetAddress(ut.getStreetAddress());
u.setAddressLine2(ut.getAddressLine2());
u.setCity(ut.getCity());
u.setState(ut.getState());
u.setPin(ut.getPin());
u.setCountry(ut.getCountry());
u.setPhoneNo(ut.getPhoneNo());
u.setEmail(ut.getEmail());
u.setDob(ut.getDob());
u.setAnniversary(ut.getAnniversary());
wbservice wb = new wbservice();
int j = wb.adduser_main(u, 1);
String from = u.getEmail();
String to = u.getEmail();
String subject = "Regarding registration Approval";
String mess = "Dear "
		+ u.getUname()
		+ ".....Your request for using MakeYourWish app...has been registered";
wb.wishalert(from, to, subject, mess);


%>
								<tr><td>
								<img alt="Wishbook" src="images/check.png" width="35px" height="35px" style="float: left; margin-left: 175px">
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">You have accepted the request</div>														
							</td></tr>
							<tr><td colspan="4">
							<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px"><form action="Admin_Approve.jsp"><input type="submit" value="back" class="buttonStyle"/></form></div>
							</td></tr>	
					</table>
