...
<%
		...
		if(from!=null)
		{
			...
			List<reminder> rs=ws.retrievereminder(from);
			int size=rs.size();
			if(size==0)
			{
%>
				<table width="550px">
					<tr>
						<td>
							...
							<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">There are no reminders set by you</div>
						</td>
					</tr>
				</table>
<%
					...
					<thead>
						<tr height="75px">
								<td colspan="4" style="font-size: 25px; float: none;color: #0b92d6;">
									<img alt="Scheduler" src="images/info.png" width="50px" height="50px" style="float: left;">
									<div style="float: left; margin-top: 10px;">Scheduled Reminders and Messages</div>
								</td>
						</tr>
						<tr height="20px" style="background-color: #e7e6eb; font-weight: bold; text-align: center;">					
							<td bordercolor="#cbcacf" style="border-style: solid;border-color: #cbcacf; border-width: 2px;">Date</td>												
							<td bordercolor="#cbcacf" style="border-style: solid;border-color: #cbcacf; border-width: 2px;">To</td>
							<td bordercolor="#cbcacf" style="border-style: solid;border-color: #cbcacf; border-width: 2px;">Subject</td>
							<td bordercolor="#cbcacf" style="border-style: solid;border-color: #cbcacf; border-width: 2px;">Delete</td>
						</tr>
					</thead>
...
<%
					for(int i=0;i<size;i++)
					{
						...
						Calendar c=Calendar.getInstance();
	 					c.setTime(r.getDateofreminder());
		 				String dateofrem=CalendarUtilityDefault.getStringFromCalendar(c);
%>
 						<tr>
 							<td><%= dateofrem %></td> 							 							
 							<td><%= service.returnName(r.getTouser().toString()) %></td> 						
 							<td><%= r.getSubject() %></td>
 							<td>
											<a href="deleteReminder.jsp?index=<%= r.getSlno() %>"><img src="images/delete.png" width="20px" height="20px" style="padding-top: 5px; margin-left: 35px"></a>
							</td>
 						</tr> 
 						<tr style="height: 5px"></tr>
<%
