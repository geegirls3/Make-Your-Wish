...
<script type="text/javascript" src="js/validation_editprofile.js"></script>
	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				Please type in the text boxes and save to update your profile <br/>
			...
			<div id="addFriendPane">
				...
				<div id="addFriendPaneMain">
					<form action="updateprofile.jsp" name="form_check">
						<table width="550px" style="color: gray;">
							<tr height="75px">
								<td colspan="2" style="font-size: 25px; float: none;color: #0b92d6;">
									<img alt="Edit Profile" src="images/Edit.png" width="50px" height="50px" style="float: left;">
									<div style="float: left; margin-top: 10px;">Edit Profile</div>
								</td>
							</tr>
<%
							String uname=(String)session.getAttribute("user_curr");
//							String uname="dinesh";
							List<user_info> rs=service.retrieveProfileInfo(uname);
							int size1=rs.size();
...
%>
    							<tr>
    								<td width="100px" class="topicStyle">First Name</td>
    								<td width="450px"><input type="text" value="<%= s.getFirstName()%>" name="firstname" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>    							
    							<tr>
    								<td class="topicStyle">Last Name</td>
    								<td><input type="text" value="<%= s.getLastName()%>" name="lastname" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
     							<tr>
     								<td class="topicStyle">Password</td>
    								<td><input type="text" value="<%= s.getPassword()%>" name="password" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
    								<td class="topicStyle">Street Address</td>
    								<td><input type="text" value="<%=s.getStreetAddress() %>" name="streetaddress" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
    								<td class="topicStyle">Address Line 2</td>
    								<td><input type="text" value="<%= s.getAddressLine2()%>" name="addressline2" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
    								<td class="topicStyle">City</td>
    								<td><input type="text" value="<%= s.getCity()%>" name="city" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
    								<td class="topicStyle">State</td>
    								<td><input type="text" value="<%= s.getState()%>" name="state" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
    								<td class="topicStyle">Pin</td>
    								<td><input type="text" value="<%= s.getPin()%>" name="pin" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
    								<td class="topicStyle">Country</td>
    								<td><input type="text" value="<%= s.getCountry()%>" name="country" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
    								<td class="topicStyle">Phone No</td>
    								<td><input type="text" value="<%= s.getPhoneNo()%>" name="phoneno" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
    								<td class="topicStyle">Email</td>
    								<td><input type="text" value="<%= s.getEmail()%>" name="email" class="textStyle"></td>
    							</tr>
    							<tr height="10px"></tr>
    							<tr>
...
%>
		 								<input type="text" value="<%= dob %>" name="dob" class="textStyle">
		 							</td>
		 						</tr>
		 						<tr height="10px"></tr>
		 						<%if(anni!=null){ %>
...
<%
    									...
    									String ann=CalendarUtilityDefault.getStringFromCalendar(c1);
%>
    									<input type="text" value="<%= ann%>" name="anniversary" class="textStyle">
    								</td>
    							</tr>
    							<tr height="10px"></tr>
    							<%} 
		 							...
		 							%>
		 							<input type="hidden" value="" name="anniversary" class="textStyle">
		 							<%
		 						}
    							%>
      							<tr>
      								<td>
      									...
      									<input type="hidden" value="<%= s.getUname()%>" name="uname">
      									<input type="hidden" value="<%=s.getTw() %>" name="tw">
      									<input type="hidden" value="<%=s.getPe() %>" name="pe">
      									<input type="hidden" value="<%=s.getFb() %>" name="fb">
      									<input type="hidden" value="<%=s.getLi() %>" name="li">
      									<input type="hidden" value="<%=s.getPropic() %>" name="propic">
      								</td>
      							</tr>      							
<%
							}
%>
						...
						<input type="submit" value="Save" name="asd" onclick="return fn1()" id="saveChanges"/>
					</form>
				</div>
