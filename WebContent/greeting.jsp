	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				Select an occasion to view the available greeting templates...<br/>
			...
			<div id="addFriendPane">
				...
				<div id="addFriendPaneMain">
					<form action="greeting.jsp" method="post" name="form_addItemForm">
						<table id="newFriendEntryList">
							<tr><td>
							<select name="list" class="optionList" style="border-style: solid; border-color: #cbcacf; border-width: 2px;">
							...
							<tr><td>							
							<input type="submit" value="Select" id="occassions" style="margin-left: 15px">
							</td></tr>
						</table>
					</form>
<%
...
%>
								...
								<input type="radio" name="Holi" onclick="location.href='retrieveGreeting.jsp?param=holi_greeting1.jpg'"  value="holi_greeting1.jpg" style="float: left;"><img alt="Holi1" width="100" height="100" src="images/greeting/holi_greeting1.jpg" style="float: left; margin-left: 5px">
								<input type="radio" onclick="location.href='retrieveGreeting.jsp?param=holi_greeting2.jpg'" name="Holi" value="holi_greeting2.jpg" style="float: left; margin-left: 15px"><img alt="Holi1" width="100" height="100" src="images/greeting/holi_greeting2.jpg" style="float: left; margin-left: 5px">
								</div>
<%
							}
							else if(name.equals("Diwali"))
							{
%>
								<div class="optionList">
								<input type="radio" name="Diwali" onclick="location.href='retrieveGreeting.jsp?param=diwali1.bmp'"  value="diwali1.bmp" style="float: left;"><img alt="diwali1" width="100" height="100" src="images/greeting/diwali1.bmp" style="float: left; margin-left: 5px"> 								
								<input type="radio" name="Diwali"onclick="location.href='retrieveGreeting.jsp?param=diwali2.bmp'"  value="diwali2.bmp" style="float: left; margin-left: 15px"><img alt="diwali2" width="100" height="100" src="images/greeting/diwali2.bmp" style="float: left; margin-left: 5px">
								</div>
<%
							}
...
%>
								<div class="optionList">
								<input type="radio" name="Christmas" onclick="location.href='retrieveGreeting.jsp?param=christmas_greeting1.jpg'" value="christmas_greeting1.jpg" style="float: left;"><img alt="christmas1" width="100" height="100" src="images/greeting/christmas_greeting1.jpg" style="float: left; margin-left: 5px"> 							
								<input type="radio" name="Christmas"onclick="location.href='retrieveGreeting.jsp?param=christmas_greeting2.jpg'"  value="christmas_greeting2.jpg" style="float: left; margin-left: 15px"><img alt="christmas2" width="100" height="100" src="images/greeting/christmas_greeting2.jpg" style="float: left; margin-left: 5px">
								</div>
<%
							}
 							else if(name.equals("Pongal"))
							{
%>
								<div class="optionList">
								<input type="radio" name="Pongal" onclick="location.href='retrieveGreeting.jsp?param=pongal_greeting1.jpg'"  value="pongal_greeting1.jpg" style="float: left;"><img alt="christmas1" width="100" height="100" src="images/greeting/pongal_greeting1.jpg" style="float: left; margin-left: 5px"> 								
								<input type="radio" name="Pongal" onclick="location.href='retrieveGreeting.jsp?param=pongal_greeting2.jpg'"  value="pongal_greeting2.jpg" style="float: left; margin-left: 15px"><img alt="christmas2" width="100" height="100" src="images/greeting/pongal_greeting2.jpg" style="float: left; margin-left: 5px">
								</div>
<%
							}
...
%>
								<div class="optionList">
								<input type="radio" name="Onam" onclick="location.href='retrieveGreeting.jsp?param=onam_greeting1.jpg'"  value="onam_greeting1.jpg" style="float: left;"><img alt="christmas1" width="100" height="100" src="images/greeting/onam_greeting1.jpg" style="float: left; margin-left: 5px"> 								
								<input type="radio" name="Onam"onclick="location.href='retrieveGreeting.jsp?param=onam_greeting2.jpg'"  value="onam_greeting2.jpg" style="float: left; margin-left: 15px"><img alt="christmas2" width="100" height="100" src="images/greeting/onam_greeting2.jpg" style="float: left; margin-left: 5px">
								</div>
<%
							}
...
%>
								<div class="optionList">
								<input type="radio" name="Eid"onclick="location.href='retrieveGreeting.jsp?param=bakrid_greeting1.jpg'" value="bakrid_greeting1.jpg" style="float: left;"><img alt="christmas1" width="100" height="100" src="images/greeting/bakrid_greeting1.jpg" style="float: left; margin-left: 5px"> 								
								<input type="radio" name="Eid" onclick="location.href='retrieveGreeting.jsp?param=bakrid_greeting2.jpg'"  value="bakrid_greeting2.jpg" style="float: left; margin-left: 15px"><img alt="christmas2" width="100" height="100" src="images/greeting/bakrid_greeting2.jpg" style="float: left; margin-left: 5px">
								</div>
<% 
							}
 							else if(name.equals("Dussehra"))
							{ 
%>
								<div class="optionList">
								<input type="radio" name="Dussehra" onclick="location.href='retrieveGreeting.jsp?param=dussehra_greeting1.jpg'"  value="dussehra_greeting1.jpg" style="float: left;"><img alt="christmas1" width="100" height="100" src="images/greeting/dussehra_greeting1.jpg" style="float: left; margin-left: 5px"> 								
								<input type="radio" name="Dussehra" onclick="location.href='retrieveGreeting.jsp?param=dussehra_greeting2.jpg'"  value="dussehra_greeting2.jpg" style="float: left; margin-left: 15px"><img alt="christmas2" width="100" height="100" src="images/greeting/dussehra_greeting2.jpg" style="float: left; margin-left: 5px">
								</div>
<%
							} 
						}
