	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				P.S. The paint app might be minimized.<br/>
				Click on the <b><i>Retrieve</i></b> button to access your custom greeting<br/>
			...
			<div id="mailPane">
				...
				<div id="mailPaneMain">
					<table id="inboxMailList" width="550px">
						<tr height="75px">
							<td style="font-size: 25px; float: none;color: #0b92d6;">
								<img alt="Wishbook" src="images/palette.png" width="50px" height="50px" style="float: left;">
								<div style="float: left; margin-top: 10px;">Custom Greetings</div>
							</td>
						</tr>		
						<tr>							
							<td>							
								<form action="displayCustomPic.jsp">
									<div class="refresh">
										<img src="../greeting.jpg"/>
										<input id="loadImage" value="Load" type="submit" class="buttonStyle"/>	
									</div>
								</form>
							</td>
						</tr>						
