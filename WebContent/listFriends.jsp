...
//						String username = "g_vinodkumar";
				...
				Please click on the friends name to view their profile...<br/>
					...
					<table id="newFriendEntryList">
						<tr>
    						<td colspan="2" style="font-size: 25px; color: #0b92d6; float: none;">
    							<img alt="Profile" src="images/Format Bullets.png" width="50px" height="50px" style="float: left;"/>
    							<div style="float: left; margin-top: 10px;">Wish List</div>
    						</td>    							
    					</tr>
    					<tr height="10px"></tr>
<%
						//(String)session.getAttribute("user_curr")
...
%>
							<tr>
								<td><img id="addFriendBullet" src="images/User.png" height="25px" width="25px"/></td>
					        	<td><a id="addFriendName" href="viewProfile.jsp?user=<%= uname_friend %>"><%= name_friend %></a></td>
					        </tr>					
<%
						}}
						catch(Exception e){
