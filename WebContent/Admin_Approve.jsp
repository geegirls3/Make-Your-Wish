					...
					<table width="550px">
						<tr height="75px">
							<td colspan="2" style="font-size: 25px;float: none;color: #0b92d6;">
								...
								<div style="float: left; margin-top: 10px;">Pending Requests</div>
							</td>
						</tr>
<%
						wbservice wb=new wbservice();
						
						List<user_info_temp> rs=wb.retrieveuser(null);
						int size=rs.size();
...
%>
    						<tr>
    							...
    							<td width="520px"><a id="newUserName" href="Admin_Aprrove_details.jsp?uname=<%= s.getUname() %>"><%= s.getUname() %></a></td>    							
    						</tr>
<%	
						}
...
%>						
								...
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">No pending requests</div>
								</td></tr>						
								</table>
<%
									}
