	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				Please select your friend to whom you would like to send the greeting...<br/>
			...
			<div id="addFriendPane">
				...
				<div id="addFriendPaneMain">
					<form action="greetingSendSuccess.jsp" method="post" name="form_addItemForm">
						<table id="selectedGreeting">
							<tr><td>
<%							 try{
								String email = service.returnEmail(username);
								List friends = service.listExistingfriends(email);
								String n;
   								n=request.getParameter("param");   	
%>
								<img alt="" src="images/greeting/<%= n %>" style="margin-left: 30px; border-style: solid; border-color: #cbcacf; border-width: 2px;">
							</td></tr>
							<tr>
								<td style="float: none;">
...
%>									
								...
								<input type="hidden" name="txtPath" id="txtPath" value="<%= n %>">							
								</td>
							</tr>					
														
							<tr><td>							
							<input type="submit" value="Send" id="sendGreeting" style="margin-left: 30px">
							</td></tr>
<%} 
							catch(Exception e){
%>						
							...
							<tr><td colspan="4">
							<img alt="Wishbook" src="images/error.png" width="35px" height="35px" style="float: left; margin-left: 190px">
							<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">No Friends found </div>
							</td></tr>						
							</table>
<%
}
