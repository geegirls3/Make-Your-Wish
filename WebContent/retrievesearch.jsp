				...
				<div id="mailPaneMain">
							...
							<tr height="75px">
								<td style="font-size: 25px; float: none;color: #0b92d6;">
									...
									<div style="float: left; margin-top: 10px;">Search</div>
								</td>
							</tr>		
...
wbservice my=new wbservice();
List<user_info> lists = my.search(search);
int size=lists.size();
if(size==0)
{
	%>
	<tr><td colspan="4">
	<img alt="Wishbook" src="images/error.png" width="35px" height="35px" style="float: left; margin-left:185px">
	<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">No results found</div>
</td></tr>	
	<%
}
else
...
{
	user_info m = (user_info)lists.get(j);
			%><tr><td colspan="4">
			<img id="menuBottomFAQLinkImage" src="images/home/bullet.png" height="12px" width="9px"/><a id="menuBottomFAQLink" style="text-decoration:none; color:gray" href="viewProfile.jsp?user=<%=m.getUname()%>"><%=m.getUname() %></a><br/>
