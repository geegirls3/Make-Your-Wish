...
<%@page import="com.customFunctions.PaintApp"%>
<%@ page import="java.io.*" %>
	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				You may now navigate away from this page...<br/>
					...
					<table id="inboxMailList">
						<tr height="75px">
							<td style="font-size: 25px; float: none;color: #0b92d6;">
								<img alt="Wishbook" src="images/customGreeting.png" width="50px" height="50px" style="float: left;">
								<div style="float: left; margin-top: 10px;">Send retrieved design</div>
							</td>
						</tr>		
						<tr>							
							<td>
								<form action="customSend.jsp">							
								<%
								
									String path=System.getProperty("user.home") + "\\Desktop\\greeting.png";
								try{
									String email = service.returnEmail(username);
									List friends = service.listExistingfriends(email);
								%>								
...
%>
								...
								<input type="hidden" name="txtPath" id="txtPath" value="<%= path %>">	
								<input type="submit" value="Send" class="buttonStyle">
<%
								}
								catch(Exception e){
									%>						
																<table id="inboxMailList">		
																<tr><td colspan="4">
																	<img alt="Wishbook" src="images/error.png" width="35px" height="35px" style="float: left; margin-left: 175px">
																	<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">No friends were found</div>
																</td></tr>						
																</table>
									<%
														}
