	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				Friend request was rejected by you.You may now navigate away from this page...<br/>
...
if(to!=null)
{
	...
	//out.println("done");
	ws.wishalert(to,from,"Friend Request","Your friend request is rejected by "+ws.returnName(to));
...
%>
								<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">You rejected friend request</div>
							</td></tr>						
							</table>
				</div>
