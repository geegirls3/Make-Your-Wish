	...
	<div id="main" style="width: 1024px;">
		<div id="left">
			...
			<div id="menuBottom">
				...
				Please select the occasion from the list to view the greeting templates...<br/>
			...
			<div id="addFriendPane">
				...
				<div id="addFriendPaneMain">
					<form action="greetings_misc.jsp" method="post" name="form_addItemForm">
...
%>
									<div class="optionList">
										<input type="radio" name="Birthday" onclick="location.href='retrieveGreeting.jsp?param=birthday_greeting1.jpg'" value="holi_greeting1.jpg" style="float: left;"><img alt="birthday1" width="100" height="100" src="images/greeting/birthday_greeting1.jpg" style="float: left; margin-left: 5px">
										<input type="radio" onclick="location.href='retrieveGreeting.jsp?param=birthday_greeting2.jpg'" name="Birthday" value="holi_greeting2.jpg" style="float: left; margin-left: 15px"><img alt="birthday2" width="100" height="100" src="images/greeting/birthday_greeting2.jpg" style="float: left; margin-left: 5px">
									</div>
<%
								} 
...
%>
									<div class="optionList">
										<input type="radio" name="Anniversary" onclick="location.href='retrieveGreeting.jsp?param=anniversary_greeting1.jpg'" value="diwali1.bmp" style="float: left;"><img alt="anniversary1" width="100" height="100" src="images/greeting/anniversary_greeting1.gif" style="float: left; margin-left: 5px">
										<input type="radio" name="Anniversary" onclick="location.href='retrieveGreeting.jsp?param=anniversary_greeting2.jpg'" value="diwali2.bmp" style="float: left; margin-left: 15px"><img alt="anniversary2" width="100" height="100" src="images/greeting/anniversary_greeting2.jpg" style="float: left; margin-left: 5px">
									</div>
<%
								}
							}
