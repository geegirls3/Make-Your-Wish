...
<%
		...
		if(from!=null)
		{
			...
			List<seasons> rs=ws.retrieveseason(from);
			int size=rs.size();
			if(size==0)
			{
%>
				<table width="550px">
					<tr>
						<td>
							...
							<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">There are no seasons greetings saved by you</div>
						</td>
					</tr>
				</table>
<%
					...
					<thead>
						<tr height="75px">
								<td colspan="4" style="font-size: 25px; float: none;color: #0b92d6;">
									...
									<div style="float: left; margin-top: 10px;">Seasons Wish List</div>
								</td>
						</tr>
						<tr height="20px" style="background-color: #e7e6eb; font-weight: bold; text-align: center;">					
							...
							<td bordercolor="#cbcacf" style="border-style: solid;border-color: #cbcacf; border-width: 2px;">Occasion</td>
							<td bordercolor="#cbcacf" style="border-style: solid;border-color: #cbcacf; border-width: 2px;">On</td>
...
<%
					for(int i=0;i<size;i++)
					{
						...
						Calendar c=Calendar.getInstance();
   						c.setTime(r.getDateoffest());
  						String dateofseason=CalendarUtilityDefault.getStringFromCalendar(c);
%>
 						<tr>
 							<td><%= service.returnName(r.getFname().toString()) %></td>
 							<td><%= r.getFestivalname() %></td>
 							<td><%= dateofseason %></td>
 							<td>
											<a href="deleteSeasons.jsp?index=<%= r.getSlno() %>"><img src="images/delete.png" width="20px" height="20px" style="padding-top: 5px;"></a>
							</td>
 						</tr> 
 						<tr style="height: 5px"></tr>
<%
