...
//						String username = "deepakkrishnan";
			...
			<div id="addFriendPane">
				...
				<div id="addFriendPaneMain">
					<form id="postMessage" action="wishbook_external_friend.jsp" style="width: 565px; vertical-align: middle">
...
<%
						String to=request.getParameter("frdmail");
						%><input type="hidden" name="frdmail" value="<%=to%>"/>
<%
						
						String text2=request.getParameter("msgText");
						//		out.println(text2);
						String from=service.returnEmail(username);//currentuser
						...
						<table width="550px" style="color: gray; margin-left: 10px;">
							<tr height="75px">
								<td style="font-size: 25px; float: none;color: #0b92d6;">
									...
									<div style="float: left; margin-top: 10px;"><%= service.returnName(to) %>'s Wishbook</div>
								</td>
							</tr>
<%
						int a=0;
...
<%
												if(ent1.getFromuser().equalsIgnoreCase(service.returnEmail(username)))
												{
%>													
													<a href="deletewish.jsp?slno=<%=ent1.getSlno() %>" style="float: right;">
...
<%
						...
						{
%>
							<a style="text-decoration: none; float: left;" href="wishbook_external_fnext.jsp?fromno=<%= k %>&to=<%=to %>"><img src="images/plus.png" width="25px" height="25px" title="Go to page <%= k %>"></a>
<%
						}
%>
						</td></tr>
...
<%
						...
						<tr><td colspan="4">
							...
							<div style="font-size: 15px; color: #0b92d6; float: left; margin-top: 8px">There are no wishes to list in wishbook</div>
						</td></tr>						
						</table>
<%
					}
